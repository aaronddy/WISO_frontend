          ...
          <div className="margin">
            <div className="flexDirRow relative marginBm1">
              <div className="flexStart alignCenter">
                <a href="#">
                  <button className="top background white cursor">miso</button>
                </a>
              ...
              <div className="arrow">
                <a href="#">
                  <button className="background border cursor">
                    <img
                      className="topArrow"
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR16gBuuXe8mxsQET5S5IKhU8TgkaOaXEmed1j7lhcnXVGDYfdHUw&s"
                    ></img>
                  </button>
                </a>
              </div>
